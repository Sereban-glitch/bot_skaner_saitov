...
RISK_ACTIONS = ['проверка', 'проверяют', 'документ', 'паспорт', 'стоят', 'тормозят', 'прессуют', 'шмонают', 'пишут', 'остановили', 'блокпост', 'вяжут', 'задерж', 'катаются', 'поехали', 'ходят', 'сидят', 'пьют', 'отдыхают', 'курят', 'трутся']
